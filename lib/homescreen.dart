...
import 'package:two_in_one/calculator.dart';
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => StWatch()),
                  );
                },
                child: Card(
                  color: Colors.lightBlue,
              ...
              InkWell(
                ...
                child: Card(
                  ...
                  child: Padding(
                    padding: EdgeInsets.symmetric(horizontal: 90,vertical: 30),
                    child: Text('Calculator',style: TextStyle(fontSize: 25,color: Colors.white),),
                    ),
                ),
              ),
            ],
